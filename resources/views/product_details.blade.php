                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                    <div class="relative h-96">
                        <img src="https://images.unsplash.com/photo-1741805190625-7386d2180e57?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw1M3x8fGVufDB8fHx8fA%3D%3D"
                             alt="Manuscrit Médiéval Enluminé"
                             class="w-full h-full object-cover">
                    </div>

                    <!-- Thumbnails -->
                    <div class="grid grid-cols-4 gap-2 p-4">
                        <div class="cursor-pointer border-2 border-blue-500 rounded-md overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1741805190625-7386d2180e57?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw1M3x8fGVufDB8fHx8fA%3D%3D"
                                 alt="Vue principale"
                                 class="w-full h-20 object-cover">
                        </div>
                        <div class="cursor-pointer border-2 border-gray-200 dark:border-gray-700 rounded-md overflow-hidden hover:border-blue-500">
                            <img src="https://images.unsplash.com/photo-1555862124-94e8b7d27ab8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWVkaWV2YWwlMjBtYW51c2NyaXB0fGVufDB8fDB8fHww"
                                 alt="Détail 1"
                                 class="w-full h-20 object-cover">
                        </div>
                        <div class="cursor-pointer border-2 border-gray-200 dark:border-gray-700 rounded-md overflow-hidden hover:border-blue-500">
                            <img src="https://images.unsplash.com/photo-1638464782702-bdee2943e834?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bWVkaWV2YWwlMjBtYW51c2NyaXB0fGVufDB8fDB8fHww"
                                 alt="Détail 2"
                                 class="w-full h-20 object-cover">
                        </div>
                        <div class="cursor-pointer border-2 border-gray-200 dark:border-gray-700 rounded-md overflow-hidden hover:border-blue-500">
                            <img src="https://images.unsplash.com/photo-1645249344164-f839a2ed1070?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YW50aXF1ZSUyMG1hbnVzY3JpcHR8ZW58MHx8MHx8fDA%3D"
                                 alt="Détail 3"
                                 class="w-full h-20 object-cover">
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="mt-6 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                        ...
                        <div>
                            <div class="flex space-x-4 mb-4">
                                <button class="flex-1 py-2 px-3 border rounded text-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">9,000 €</button>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-auto">
                                <a href="#" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Voir le profil</a>
                            </div>
                        </div>
                    </div>
                </div>
