...
<body class="bg-gray-50">
    ...
    <!-- New Article Modal -->
    <div id="newArticleModal" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-xl shadow-lg max-w-2xl w-full my-8">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-bold text-gray-900">Create New Article</h3>
                        <button onclick="closeNewArticleModal()" class="text-gray-400 hover:text-gray-500">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                    <form id="newArticleForm" class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Title</label>
                            <input type="text" name="title"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                <div class="border-2 border-gray-300 rounded-lg overflow-hidden max-h-[200px] bg-white">
                                    <!-- Search Bar -->
                                    <div class="p-2 border-b border-gray-200 sticky top-0 bg-white z-10">
                                        <div class="relative">
                                            <input type="text"
                                                   ...
                                                   class="w-full pl-8 pr-4 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200">
                                    ...
                                    <!-- Tags Grid -->
                                    <div class="overflow-y-auto custom-scrollbar" style="max-height: calc(200px - 40px);">
                                        <div class="grid grid-cols-2 gap-2 p-2" id="tagsGrid">
                                            @foreach ($tags as $tag)
                                                <div class="tag-item">
                                                    <button type="button"
                                                            onclick="toggleTag('{{$tag->id}}', '{{$tag->name}}')"
                                                            class="w-full p-2 text-left bg-white border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-200 transition-colors duration-200 group">
                                                        <div class="flex items-center justify-between">
                                                            <span class="text-sm font-medium text-gray-900">{{$tag->name}}</span>
                                                            <i class="fas fa-check text-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-sm"></i>
                                                        </div>
                                                    </button>
                                                </div>
                                            @endforeach
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-purple-300 transition-colors duration-200">
                        ...
                        <div class="flex justify-end pt-4">
                            <button type="submit" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors duration-200">
                                Publish Article
                            </button>
                        </div>
                    </form>
