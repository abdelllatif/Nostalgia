    ...
    <aside class="bg-gray-800 text-white w-64 flex-shrink-0 hidden md:block">
        ...
        <div class="mt-6">
            <nav>
                ...
                <a href="admin-tags" class="block py-3 px-6 bg-gray-700 text-white flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button onclick="openEditTagForm(this)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" data-id="{{ $tag->id }}" data-name="{{ $tag->name }}">Modifier</button>
