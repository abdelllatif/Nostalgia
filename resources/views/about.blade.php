...
<head>
    ...
    <title>À Propos - Nostalogia</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <nav class="bg-white shadow-md px-6 py-4 flex  items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
          <img src="https://img.icons8.com/ios-filled/50/000000/retro-tv.png" alt="Logo Nostalgia" class="w-6 h-6 md:w-8 md:h-8 ">
          <span class="text-md md:text-xl  font-bold text-gray-800">Nostalgia</span>
        </div>

        <!-- Menu -->
        <ul class="hidden md:flex space-x-6 text-gray-700 font-medium">
          <li><a href="/" class="hover:text-blue-600">Accueil</a></li>
          <li><a href="/encheres" class="hover:text-blue-600">Enchères</a></li>
          <li><a href="/collections" class="hover:text-blue-600">Collections</a></li>
          <li><a href="/apropos" class="hover:text-blue-600 text-blue-600">À propos</a></li>
        ...
        <div class="hidden md:hidden">
            <a href="/profile">
            <img src="https://images.unsplash.com/photo-1640951613773-54706e06851d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8dXNlcnxlbnwwfHwwfHx8MA%3D%3D" alt="user profile image"
            class="w-17 h-10 rounded-3xl" >
            </a>
        </div>
        <!--  berger menu -->
        <div class="md:hidden">
